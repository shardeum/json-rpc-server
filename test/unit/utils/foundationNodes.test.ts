...
import { loadFoundationNodes, isFoundationNode, isFoundationNodeFilteringEnabled, getFoundationNodesCount } from '../../../src/utils/foundationNodes'
    ...
    describe('loadFoundationNodes', () => {
        ...
        it('should load foundation nodes from endpoint successfully', async () => {
            ...
            expect(mockedAxios.get).toHaveBeenCalledWith(
                'http://127.0.0.1/foundation-nodes',
