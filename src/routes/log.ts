...
router
  .route('/log/api-stats')
  .get(rateLimitedDebugAuth(isDebugModeMiddlewareLow), async (req: CustomRequest, res: Response) => {
    try {
...
router
  .route('/log/cleanStatTable')
  .get(rateLimitedDebugAuth(isDebugModeMiddlewareLow), async (req: Request, res: Response) => {
    try {
...
router
  .route('/log/txs')
  .get(rateLimitedDebugAuth(isDebugModeMiddlewareLow), async function (req: Request, res: Response) {
    try {
