...
export class RequestersList {
    ...
    constructor(blackList: string[] = [], spammerList: string[] = [], whiteList: string[] = []) {
      ...
      if (config.rateLimit) {
        ...
        if (typeof config.rateLimitOption.releaseFromBlacklistInterval !== 'number' || typeof config.rateLimitOption.spammerCheckInterval !== 'number') {
